		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Data Peserta Magang</h1>
										...
										<tbody>
											...
											<?php foreach ($pendaftaran as $pendaftaran) : ?>
												...
												<tr>
													...
													<td>
														<?php
														$year = substr($pendaftaran->tgl_mulai, 0, 4);
														$month = substr($pendaftaran->tgl_mulai, 5, 2);
														$day = substr($pendaftaran->tgl_mulai, 8, 2);
														echo $day . '-' . $month . '-' . $year;
														?>
													</td>
													...
													<td>
														<?php
														$year = substr($pendaftaran->tgl_selesai, 0, 4);
														$month = substr($pendaftaran->tgl_selesai, 5, 2);
														$day = substr($pendaftaran->tgl_selesai, 8, 2);
														echo $day . '-' . $month . '-' . $year;
														?>
													</td>
													...
													<td>
														...
														<button type="button " id="btnSubmit" class="btn btn-primary  btnAdd" data-toggle="modal" data-target="#tugas" data-id="<?= $pendaftaran->id; ?>">
															Pilih
														</button>
