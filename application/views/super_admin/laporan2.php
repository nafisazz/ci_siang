											...
											foreach ($pendaftaran as $pendaftaran) : ?>
												<tr>
													...
													<td class="text-center"><b><span></span></b>
														...
														<?php
														if ($pendaftaran['acc'] == 'lolos') {
															echo '<span><a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#penilaian' . $pendaftaran['id'] . '"><i class="fa fa-edit fa-sm"></i></a></span>';
														} elseif ($pendaftaran['acc'] == 'tidak_aktif') {
															echo '<span><button href="" class="btn btn-warning btn-sm disabled"><i class="fa fa-edit fa-sm"></i></button></span>';
														}
														?>
														<span><a href="<?php echo base_url('superadmin/getkegiatan/' . $pendaftaran['id']) ?>" class="btn btn-info btn-sm"><i class="fa fa-tasks fa-sm"></i></a></span>
													</td>
												</tr>
