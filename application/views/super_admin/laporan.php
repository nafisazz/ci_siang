		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">Laporan Magang</h1>
				</div>
				<!-- /.container-fluid -->
				<!-- ISI INDEX -->
				<div class="col-md-12">
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">Tabel Laporan Nilai</h6>
						</div>
						<div class="card-body">
											...
											<tbody>
												...
												<?php foreach ($peserta as $peserta) : ?>
													<tr>
														...
														<td class="text-center"><?= $peserta['asal_sekolah']; ?></td>
														<td class="text-center"><?= $peserta['jurusan']; ?></td>
														<td class="text-center"><?= $peserta['divisi']; ?></td>
														<td class="text-center"><?= $peserta['tgl_selesai']; ?></td>
														<td class="text-center">
															<a type="button" class="btn btn-info btn-sm" href="<?= base_url('superadmin/penilaian/') . $peserta['id'] ?>"><i class="fas fa-eye fa-sm"></i></a>
														</td>
													</tr>
												<?php endforeach; ?>
											</tbody>
